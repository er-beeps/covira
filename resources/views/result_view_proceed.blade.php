        ...
        <div class="row">
            <div class="col">
                <div class="card h-100">
                    <div class="card-header bg-secondary p-1"><i class="fa fa-info"><b>Info</b></i></div>
                    <div class="card-body p-3">
                        <b>We are conducting research on the impact of this pandemic, hence would you like to help us by answering few more questions?<br/> <span style="color:red">*Note- If you have done it earlier, no need to repeat it.</span></b>
                    </div>
